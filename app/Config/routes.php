 ...
 */
Router::connect('/', array('controller' => 'index', 'action' => 'index'), array('routeClass' => 'I18nRoute'));
...
/* App::uses('CmsRoutes', 'Cms.Lib');
  CmsRoutes::init(); */
Router::connect('/strona/:id/:slug', array(
    'controller' => 'cmspages',
    'action' => 'view'
        ), array('pass' => array('id', 'slug'))
);
Router::connect('/kategoria/:id/:slug', array(
    'controller' => 'pagegroups',
    'action' => 'view'
        ), array('pass' => array('id', 'slug'))
);
/**

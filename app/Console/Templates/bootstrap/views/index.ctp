    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <ul class="pagination pagination-sm">
                <?php
                echo "\t<?php\n";
                echo "\t\t\t\t\t" . 'if ($params["pageCount"] > 29) {' . "\n";
                echo "\t\t\t\t\techo \$this->Paginator->first(__('First page'));\n";
                echo "\t\t\t\t\t}\n";
                echo "\t\t\t\t\techo \$this->Paginator->prev('&larr; ' . __('Previous'), array('class' => 'prev','tag' => 'li','escape' => false), '&larr; ' . __('Previous'), array('class' => 'prev disabled','tag' => 'li','escape' => false));\n";
                echo "\t\t\t\t\techo \$this->Paginator->numbers(array('modulus' => 9, 'separator' => '','tag' => 'li','currentClass' => 'active','currentTag' => 'a'));\n";
                echo "\t\t\t\t\techo \$this->Paginator->next(__('Next') . ' &rarr;', array('class' => 'next','tag' => 'li','escape' => false), __('Next') . ' &rarr;', array('class' => 'next disabled','tag' => 'li','escape' => false));\n";
                echo "\t\t\t\t\t" . 'if ($params["pageCount"] > 29) {' . "\n";
                echo "\t\t\t\t\techo \$this->Paginator->last(__('Last page'));\n";
                echo "\t\t\t\t\t}\n";
                echo "\t\t\t\t?>\n";
                ?>
            </ul>

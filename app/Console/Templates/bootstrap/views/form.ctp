...
<div class="<?php echo $pluralVar; ?> form">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <?php
            echo "\t\t\t\t<div class=\"form-group\">\n";
            echo "\t\t\t\t\t<?php echo \$this->Form->submit(__('Save'), array('style' => 'display:inline-block;', 'class' => 'btn btn-sm btn-primary', 'div' => FALSE, 'after' => '')); ?>\n";
            echo "\t\t\t\t\t<?php echo \$this->Html->link(__('Cancel'), array(/*'admin' => \$this->request->params['admin'], */'action' => 'index'), array('style' => 'display:inline-block;', 'class' => 'btn btn-default btn-sm', 'escape' => FALSE)); ?>\n";
            echo "\t\t\t\t</div>\n\n";
            ?>
        </div>

    ...
    <div class="datatable_<?php echo $name ?> index">
        ...
        <?php echo $this->element('page_title', array('title' => __(isset($config['title']) ? $config['title'] : Inflector::pluralize(Inflector::humanize(Inflector::underscore(isset($config['model']) ? $config['model'] : $name)))), 'subtitle' => '')); ?>
    <?php echo $this->element('page_bar'); ?>
        <div class="row">
            <div class="col-md-12 col-sm-12">

                <div class="portlet light bordered-b">
...
?>
                        ...
                        <?php
                        $langFile = new File("assets/global/plugins/datatables/i18n/pl.lang");
                        $langUrl = null;
                        //if ($langFile->exists()) {
                        $langUrl = $this->Html->url("/assets/global/plugins/datatables/i18n/pl.lang", true);
                        //}
...
//                            "sSearch" =>        "Buscar:",
        ...
        ['responsivePriority' => 3, 'targets' => -1]
                    ...
                    //$js['order'] = array(array(7, "desc"));
//var_dump($js['language']);
                        $options = array();
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                var initComplete = function () {
                                        ...
                                        switch (columnSettings['type']) {
                                            case 'daterange':
                                                ...
                                                input.on('change', function () {
                                                    var val = ($(this).val());
                                                   // val="BETWEEN '2020-07-01' AND '2020-07-31'"
                                                    //console.log(val ? '' + val + '' : '');
                                            ...
                                            case 'select':
                                                ...
                                                break;
                                            case 'selectmulti':
                                                var select = $('<select class="' + elementSelectClass + '" autocomplete="false" multiple="multiple" id="' + elementId + '"><option value=""></option></select>')
                                                        .appendTo($(column.footer()).empty())
                                                        .on('change', function () {
                                                            console.log(column);
                                                            var val = $(this).val();
                                    ...
                                    $('tbody', table).on('click', '.post.ajax', function (e) {
                e.preventDefault();
  ...
  function() 
  {
     table.DataTable().ajax.reload(null, false);
                            ...
                            // error handling
                            $(this).find('.fa-circle-o-notch').remove();

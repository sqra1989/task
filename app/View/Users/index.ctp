...
<div class="container-big grid-gap">
<div class="content  main-content grid-gap no-padding-top">
    ...
    <div class="datatable_<?php echo $name ?> index">
        ...
        <?php echo $this->element('page_title', array('title' => 'Użytkownicy prywatni', 'subtitle' => '')); ?>
